      ...
      <div className="container">
        <Tabs defaultActiveKey="1" onChange={callback} style={{ marginLeft: 10 }}>
          ...
          <TabPane tab="Đổi mật khẩu" key="2">
            <div className="repass" style={{ maxWidth: 700, margin: '0px auto 15px auto', padding: 15, backgroundColor: "#edeae6" }}>
              <h2>Đổi mật khẩu</h2>
              <Form
                form={repassForm}
                layout="vertical"
          ...
          <TabPane tab="Lịch sử mua hàng" key="3">
            <div className="history" style={{ maxWidth: 1100, margin: '0px auto 15px auto', padding: 15, backgroundColor: "#edeae6" }}>
